    ...
    <div className="flex min-h-screen">
      <div className="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:px-20 xl:px-24">
        <div className="mx-auto w-full max-w-sm">
          ...
          {state === 'invalid-link' && (
            <>
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Este link é inválido ou já foi utilizado. Solicite uma nova redefinição de senha na página de login.
              </p>
          ...
          {state === 'form' && (
            <>
              <h2 className="text-2xl font-bold tracking-tight text-foreground">Redefina sua senha</h2>
              <p className="mt-2 text-sm text-muted-foreground">
      ...
      <div className="hidden flex-1 bg-primary lg:block">
        <div className="flex h-full flex-col items-center justify-center p-12">
          <div className="max-w-md text-center">
            ...
            <h2 className="text-3xl font-bold text-primary-foreground">Redefinição de senha</h2>
